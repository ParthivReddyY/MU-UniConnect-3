  ...
  return (
    ...
    >
      ...
      <div className="relative p-7 z-10 h-full flex flex-col">
        <h3 className="text-2xl font-bold mb-2 text-white">Event Booking</h3>
        ...
        <div className="mt-auto space-y-4">
          ...
          <motion.button 
            className="w-full py-3 px-4 rounded-xl font-medium bg-white text-pink-600 shadow-md hover:shadow-lg transition-all"
            whileTap={{ scale: 0.97 }}
